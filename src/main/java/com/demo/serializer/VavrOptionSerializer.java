...
public class VavrOptionSerializer extends ReferenceTypeSerializer<Option<?>> {
    ...
    protected ReferenceTypeSerializer<Option<?>> withResolved(BeanProperty prop,
        ...
        return new VavrOptionSerializer(this, prop, vts, valueSer, unwrapper, _suppressableValue, _suppressNulls);
    }

    @Override
    public ReferenceTypeSerializer<Option<?>> withContentInclusion(Object suppressableValue, boolean suppressNulls) {
        return new VavrOptionSerializer(this, _property, _valueTypeSerializer, _valueSerializer, _unwrapper,
